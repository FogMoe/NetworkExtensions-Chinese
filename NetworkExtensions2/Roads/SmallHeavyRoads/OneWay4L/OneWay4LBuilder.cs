...
namespace Transit.Addon.RoadExtensions.Roads.SmallHeavyRoads.OneWay4L
{
    public partial class OneWay4LBuilder : Activable, INetInfoBuilderPart
    {
        ...
        public string DisplayName { get { return "四线单行路"; } }
        public string Description { get { return "一条四车道的单向道路，没有停车位。 支持中等交通流量。"; } }
